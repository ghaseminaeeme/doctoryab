<%@ Page Title="" Language="C#" MasterPageFile="~/En/Site1En.Master" AutoEventWireup="true" CodeBehind="doctors.aspx.cs" Inherits="DoctorYab.En.doctors" %>
                    ...
                    <ItemTemplate>
                        <div class="col-md-6 pull-right">
                            <div class="page-title">
                                <h1>Doctors  <%#Eval("branch") %></h1>
                            </div>
                        </div>
                        <div class="col-md-6 bc-path">
                            <ol class="breadcrumb justify-content-md-end">
                                <li class="breadcrumb-item"><a href="default.aspx">Home</a></li>
                                <li class="breadcrumb-item active">Doctors  <%#Eval("searchStr") %></li>
                            </ol>
                        </div>
                    </ItemTemplate>
                </asp:FormView>
                <asp:SqlDataSource ID="SqlBreadcrumb" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                    SelectCommand="selectEnglishDoctorBreadcrumb" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row shop_container grid">
                        ...
                        <asp:SqlDataSource ID="SqlDoctors" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                            SelectCommand="selectEnglishDoctors" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                            ...
                            <asp:Panel ID="Panel1" runat="server" DefaultButton="LinkButton1">
                                <div class="widget">
                                    <div class="search_form">
                                        <asp:TextBox ID="TxtName" runat="server" class="form-control" placeholder="search name ..."></asp:TextBox>
                                    </div>
                                </div>
                                <div class="widget">
                                    <div class="custom_select">
                                        <asp:DropDownList ID="DrdCity" runat="server" class="first_null" AppendDataBoundItems="true" DataSourceID="SqlCity" DataTextField="cEnName" DataValueField="id">
                                            <asp:ListItem Value="0" Text="All Cities"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlCity" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>" SelectCommand="SELECT [id], [cEnName] FROM [TblCity] WHERE ([cIsDeleted] &lt;&gt; @cIsDeleted) ORDER BY [cEnName]">
                                            <SelectParameters>
                                ...
                                <div class="widget">
                                    <div class="custom_select">
                                        ...
                                        <asp:SqlDataSource ID="SqlBranch" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>" SelectCommand="SELECT [id], [bEnSubject] FROM [TblBranch] WHERE ([bIsDeleted] &lt;&gt; @bIsDeleted) ORDER BY [bEnSubject]">
                                            <SelectParameters>
                                ...
                                <div class="widget">
                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="btn-filter">Filter</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="Button2_Click" CssClass="btn-anti-filter">Remove filters</asp:LinkButton>
                                </div>
                            </asp:Panel>
