<%@ Page Title="" Language="C#" MasterPageFile="~/Ar/ArSite1.Master" AutoEventWireup="true" CodeBehind="DoctorDetail.aspx.cs" Inherits="DoctorYab.Ar.DoctorDetail" %>
                    ...
                    <ItemTemplate>
                        ...
                        <div class="col-md-6 bc-path">
                            <ol class="breadcrumb justify-content-md-end">
                                ...
                                <li class="breadcrumb-item"><a href="Doctors.aspx?city=<%#Eval("dCityFk") %>&branch=<%#Eval("dBranchFk") %>">الأطباء <%#Eval("bArSubject") %> <%#Eval("cName") %></a></li>
                                <li class="breadcrumb-item active"><a href="DoctorDetail.aspx?did=<%#Eval("id") %>"><%#Eval("dArName") %></a></li>
                            </ol>
                        </div>
                    </ItemTemplate>
                </asp:FormView>
                        ...
                        <asp:FormView ID="FormView3" runat="server" DataSourceID="SqlDoctor" CssClass="w-100">
                            <ItemTemplate>
                                <div class="product_img_box">
                                    <img id="product_img" src='<%#Eval("dImg") %>' alt="<%#Eval("dArName") %>" />
                        ...
                        <ItemTemplate>
                            <div class="pr_detail">
                                <div class="product_description">
                                    <h4 class="product_title"><a href="DoctorDetail.aspx"><%#Eval("dArName") %></a></h4>
                                    <div class="product_price">
                                        <span class="subtitle"><%#Eval("bArSubject") %></span>
                                        <p><%#Eval("dArSpecialty") %></p>
                                    </div>
                                    ...
                                    <div class="product_sort_info">
                                        <ul>
                                            <li><i class="linearicons-self-timer"></i>ساعات العمل: <%#Eval("dArWorkTime") %></li>
                                            <li><i class="linearicons-telephone"></i>هاتف: <a href="tel:<%#Eval("dTel") %>"><%#Eval("dTel") %></a></li>
                                            <li><i class="linearicons-telephone"></i>متحرك: <a href="tel:<%#Eval("dMobile") %>"><%#Eval("dMobile") %> </a></li>
                                            <li><i class="linearicons-map-marker"></i>عنوان: <%#Eval("cArName") %> - <%#Eval("dArAddress") %></li>
<%--                                            <li><i class="linearicons-envelope"></i>البريد الإلكتروني: <%#Eval("dEmail") %></li>
                                            <li><i class="linearicons-network"></i>موقع الكتروني: <%#Eval("dWebsite") %> </li>--%>
                                        </ul>
                                    </div>
                                </div>
                                <hr />
                                <div class="cart_extra">
                                    <div class="product_share">
                                        <span>اتبع هذا الطبيب على وسائل التواصل الاجتماعي:</span>
                                ...
                                <div class="cart_extra">
                                    <div class="cart_btn">
                                        <h4>التوجيه</h4>
                                        <a target="_blank" class="btn btn-fill-out btn-addtocart" href="https://maps.google.com/?q=<%#Eval("dLat") %>, <%#Eval("dLong") %>">خرائط جوجل</a>
                                        <a target="_blank" class="btn btn-addtocart-revers btn-map" href="https://www.waze.com/ul?ll=<%#Eval("dLat") %>,<%#Eval("dLong") %>&navigate=yes&zoom=17" >خرائط waze</a>

<%--                                        <a target="_blank" class="btn btn-addtocart-revers" href="https://balad.ir/#15.02/36.33781/59.52464">خرائط بلد</a>
                                        <a target="_blank" class="btn btn-fill-out btn-addtocart" href="https://neshan.org/maps/">خرائط نشان</a>--%>
                                    </div>
                                </div>
                                <hr />
                ...
                <div class="col-12">
                    <div class="tab-style3">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="Additional-info-tab" data-toggle="tab" href="#Additional-info" role="tab" aria-controls="Additional-info" aria-selected="true">موقع</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="Reviews-tab" data-toggle="tab" href="#Reviews" role="tab" aria-controls="Reviews" aria-selected="false">تعليقات </a>
                            </li>
                        </ul>
                        <div class="tab-content shop_info_tab">
                            ...
                            <div class="tab-pane fade" id="Reviews" role="tabpanel" aria-labelledby="Reviews-tab">
                                ...
                                <%--<div class="comments">
                                    <asp:FormView ID="FormView5" runat="server" DataSourceID="SqlDoctor" CssClass="w-100">
                                        <ItemTemplate>
                                            <h5 class="product_tab_title">نظرات در مورد <span><%#Eval("dArName") %></span></h5>
                                        </ItemTemplate>
                                    </asp:FormView>
                                ...
                                <div class="review_form field_form">
                                    ...
                                    <div class="row mt-3">
                                        <div class="form-group col-12">
                                            <asp:TextBox ID="TxtDes" runat="server" TextMode="MultiLine" placeholder="تعليق *" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <asp:TextBox ID="TxtName" runat="server" placeholder="أدخل أسمك *" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <asp:TextBox ID="TxtEmail" runat="server" placeholder="أدخل بريدك الإلكتروني أو هاتفك *" class="form-control"></asp:TextBox>
                                        </div>

                                        <div class="form-group col-12">
                                            <asp:Button ID="Button1" runat="server" Text="انشر تعليق" class="btn btn-fill-out" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
                        ...
                        <asp:SqlDataSource ID="SqlRelated" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                            SelectCommand="SELECT top 4 dbo.TblDoctors.id, dbo.TblDoctors.dArName, dbo.TblDoctors.dImg, dbo.TblBranch.bArSubject, dbo.TblCity.cArName, dbo.TblDoctors.dBranchFk 
