<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DoctorYab.Ar.Default" %>
        ...
        <form>
            ...
            <header class="header_wrap">
                            ...
                            <div class="col-lg-6 col-md-8">
                                <div class="header_topbar_info">
                                    <div class="header_offer">
                                        <span>نظام تعريف الأطباء في إيران</span>
                                    </div>
                                    <asp:FormView ID="FormView3" runat="server" DataSourceID="SqlAbout">
                                        <ItemTemplate>

                                            <div class="download_wrap">
                                                <span class="mr-3">تابعنا</span>
                ...
                <div class="middle-header dark_skin">
                    <div class="container">
                        <div class="nav_block">
                            <a class="navbar-brand" href="http://doctoryab-iran.com/Ar">
                            ...
                            <div class="product_search_form">
                                ...
                                <asp:Panel ID="Panel1" runat="server" DefaultButton="LinkButton1">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-prepend">
                                            <div class="custom_select">
                                                ...
                                                <asp:SqlDataSource ID="SqlBranch" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                                    SelectCommand="SELECT [id], [bArSubject] FROM [TblBranch] WHERE ([bIsDeleted] &lt;&gt; @bIsDeleted) ORDER BY [bArSubject]">
                                                    <SelectParameters>
                                        ...
                                        <asp:TextBox ID="TxtName" runat="server" class="form-control search-doctor" placeholder="اسم الطبيب ..."></asp:TextBox>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-3">
                                <div class="categories_wrap">
                                    ...
                                    <div id="navCatContent" class="nav_cat navbar collapse">
                                        ...
                                        <div class="more_categories"><a href="Doctors.aspx?city=0&branch=0">المزيد من الفئات</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-9 col-md-8 col-sm-6 col-9">
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
                                        <ul class="navbar-nav">
                                            <li><a class="nav-link nav_item" href="/Ar">الصفحة الأصلية</a></li>
                                            <li><a class="nav-link nav_item" href="Doctors.aspx?city=0&branch=0">الأطباء</a></li>
                                            <li><a class="nav-link nav_item" href="about.aspx">معلومات عنا</a></li>
                                            <li><a class="nav-link nav_item" href="contact.aspx">للتواصل معنا</a></li>
                                        </ul>
                                    </div>
            ...
            <div class="main_content">
                                ...
                                <div id="carouselExampleControls" class="carousel slide light_arrow" data-ride="carousel">
                                    <div class="carousel-inner">
                                        ...
                                        <asp:SqlDataSource ID="SqlTopBanner" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                            SelectCommand="selectArTopBanner" SelectCommandType="StoredProcedure"></asp:SqlDataSource>

                                        <asp:SqlDataSource ID="SqlBanner" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                            SelectCommand="selectArBanners" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                            ...
                            <div class="col-12">
                                <div class="heading_tab_header">
                                    ...
                                    <div class="tab-style2">
                                        <a href="Doctors.aspx?city=0&branch=0">كل الأطباء</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-pane fade show active">
                                        ...
                                        <div class="row shop_container grid">
                                            ...
                                            <asp:SqlDataSource ID="SqlSpecialDoctors" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                                SelectCommand="selectLastArabicSpecialDoctors" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                ...
                <asp:SqlDataSource ID="SqlAdvers" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                    SelectCommand="SELECT top 3 id, aSubject, aImage, aStateFk, aLink
                        FROM TblAdver where (aStatus &lt;&gt; 0) AND (aLAnguage = 2)  ORDER BY id DESC"></asp:SqlDataSource>
                <!-- END SECTION BANNER -->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <asp:SqlDataSource ID="SqlVideo" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                SelectCommand="SELECT TOP (8) id, vSrc, vArSubject FROM dbo.TblVideo WHERE (vSrc IS NOT NULL) AND (vStatus <> 0) AND (vLAnguage = 2) order by id desc"></asp:SqlDataSource>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="col-md-4 pull-right">
                                            <div class="doctor-item ">
                                                ...
                                                <div class="product_info">
                                                    <h6 class="product_title"><a href="DoctorDetail.aspx?did=<%#Eval("id") %>"><%#Eval("dArName") %></a></h6>
                                                    <div class="product_price">
                                                        <span class="price specialty"><%#Eval("bArSubject") %></span>
                                                        <div class="on_sale">
                                                            <span><%#Eval("cArName") %></span>
                                                            <%--<span class="tel"><a href="tel:<%#Eval("dTel") %>"><%#Eval("dTel") %></a></span>--%>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <asp:SqlDataSource ID="SqlLastDoctors" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                    SelectCommand="SELECT dbo.TblDoctors.id, dbo.TblDoctors.dArName, dbo.TblDoctors.dBranchFk, dbo.TblDoctors.dImg, dbo.TblDoctors.dCityFk, 
                                dbo.TblDoctors.dIsDeleted, dbo.TblDoctors.dStatus, dbo.TblDoctors.dTel,dbo.TblBranch.bArSubject, dbo.TblCity.cArName 
            ...
            <footer class="bg_gray">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="widget">
                                    <div class="footer_logo">
                                        <a href="http://doctoryab-iran.com/Ar">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="widget">
                                    <h6 class="widget_title">روابط مفيدة</h6>
                                    <ul class="widget_links">
                                        <li><a href="/Ar/about.aspx">معلومات عنا</a></li>
                                        <li><a href="/Ar/Doctors.aspx?city=0&branch=0">الأطباء</a></li>
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="widget">
                                    <h6 class="widget_title">قسم الأطباء</h6>
                                    <ul class="widget_links">
                                        <asp:Repeater ID="Repeater5" runat="server" DataSourceID="SqlFooterBranch">
                                            <ItemTemplate>
                                                <li><a href='/Ar/Doctors.aspx?city=0&branch=<%#Eval("id") %>'><%#Eval("bArSubject") %></a></li>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        <li><a href="/Ar/Doctors.aspx?city=0&branch=0">كل الأطباء</a></li>
                                        <asp:SqlDataSource ID="SqlFooterBranch" runat="server" ConnectionString="<%$ ConnectionStrings:DbWebSiteConnectionString %>"
                                            SelectCommand="SELECT top(5) [id], [bArSubject] FROM [TblBranch] order by newid()"></asp:SqlDataSource>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="bottom_footer border-top-tran">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <p class="mb-lg-0 text-center">© 1399 جميع حقوق هذا الموقع مملوكة لدکتریاب ایران</p>
                            </div>
