<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite1.Master" AutoEventWireup="true" CodeBehind="editDoctor.aspx.cs" Inherits="_DoctorYab.Admin.editDoctor" %>
        ...
        <div class="col-md-12">
            <div class="panel-body">
               ...
               <div class="form-group col-md-4 col-xs-12 pull-right">
                ...
                <hr>
                <div class="form-group">
                    <label>آدرس ویدئو 1 </label>
                    <asp:TextBox ID="TxtVideo" class="form-control" runat="server"></asp:TextBox>
                </div>
                <hr />
                 <div class="form-group">
                    <label>آدرس ویدئو 2 </label>
                    <asp:TextBox ID="TxtVideo2" class="form-control" runat="server"></asp:TextBox>
                </div>
                <hr />
                 <div class="form-group">
                    <label>آدرس ویدئو 3 </label>
                    <asp:TextBox ID="TxtVideo3" class="form-control" runat="server"></asp:TextBox>
                </div>
                <hr />
                <div class="form-group col-md-12 col-xs-12 pull-right">
